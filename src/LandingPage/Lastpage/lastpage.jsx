        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex justify-around mt-8 space-x-4">
            <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
              ...
              <a href="#" className="text-red-800 font-bold mt-4 block">Read More</a>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
              <span className="text-red-500 font-bold text-xl">02.</span>
              <h3 className="text-2xl font-bold mt-2">Video Calls Option</h3>
              <p className="text-lg font-light mt-2">We can easily chat through text and messesges including video calls </p>
